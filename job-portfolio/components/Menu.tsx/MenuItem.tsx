...
const MenuItem: NextPage<Props> = (props) => {
    return(
        <div style={{display: props.show ? "flex" : "hidden"}} className="menus hidden md:hidden flex-row-reverse bg-black/30 fixed z-90 md:top-[80%] lg:right-[30rem]
        right-[1rem] top-[80%] z-10
