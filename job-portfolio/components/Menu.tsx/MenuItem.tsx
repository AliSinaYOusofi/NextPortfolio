...
const MenuItem: NextPage<Props> = (props) => {
    ...
    return(
        <div className="flex md:items-center  md:justify-center p-">
            
            <div style={{display: props.show ? "flex" : "hidden", borderRadius: menu ? "" : "50%", 
        ...
        bg-black/50 fixed z-90 md:top-[87%]  lg:top[91%] 
        top-[89%]   bitch w-fit
        ...
        hover:blur-none">
            
            {
                ...
                <>
                    ...
                    lg:p-2 py-2 px-3 rounded-lg cursor-pointer"
                    ...
                    z-10  lg:p-2 py-2 px-3 rounded-lg cursor-pointer"
                    style={{color: theme ? "gray" : "black" , backgroundColor: theme ? "#04060A" : "white"}}>
