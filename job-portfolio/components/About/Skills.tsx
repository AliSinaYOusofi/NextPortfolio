...
const Skills: NextPage = () => {
    ...
    return (
        <div style={{backgroundColor: theme ? "" : ""}} className=" text-white py-2 px-2 rounded-lg">
            ...
            <div className="mt-2 one flex justify-between items-center flex-wrap  gap-y-3 md:gap-x-0 gap-x-1" ref={targetRef}>
                ...
                <SkillsCard link={"https://www.javascript.com"} text={"JavaScript is a scripting language that enables you to create dynamic web pages. Javascript used to make pages look alive"} icon={<IoLogoJavascript />} header="Javascript"/>
                <SkillsCard link={"https://sass-lang.com"} text={"Sass is a preprocessor scripting language that is interpreted or compiled to css. Sass is a scripting language."} icon={<FaSass />} header="SASS"/>
            ...
            <div className="flex two justify-between items-center flex-wrap gap-x-1 gap-y-3">
