    ...
    return (
        ...
        <div className="mt-4">
            ...
            <div className="flex gap-x-2 text-2xl mt-3">
                <div style={{backgroundColor: theme ? "#060A11" : "white", boxShadow: theme ? "2px 2px 4px black" : "1px 2px 8px darkgray"}} onClick={facebookError} ref={one} onMouseEnter={blueOne} onMouseLeave={undoBlurOne} className="icon1 transition-all duration-300  bg-[#1D1D1D] p-2 cursor-pointer after:bg-gray-400  rounded-md"> <BsFacebook /> </div>
                <Link style={{backgroundColor: theme ? "#060A11" : "white", boxShadow: theme ? "2px 2px 4px black" : "1px 2px 8px darkgray"}} target="_blank" href="https://twitter.com/shreddedDev" className="rounded-md"> <div   ref={two} onMouseEnter={blurTwo} onMouseLeave={undoBlurTwo} className="icon2 face transition-all duration-300  p-2 cursor-pointer   rounded-md"> <BsTwitter /></div></Link>
                <Link style={{backgroundColor: theme ? "#060A11" : "white", boxShadow: theme ? "2px 2px 4px black" : "1px 2px 8px darkgray"}} target="_blank" href="https://t.me/sinayousofi" className="rounded-md"><div ref={three} onMouseEnter={blurThree} onMouseLeave={undoBlurThree}  className="icon3 transition-all duration-300  p-2 cursor-pointer  rounded-md"> <BsTelegram /> </div></Link>
