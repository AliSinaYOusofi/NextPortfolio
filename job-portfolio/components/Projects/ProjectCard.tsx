    ...
    return (
        ...
        <div className="mt-10 md:w-[16rem] w-[10rem] h-fit relative rounded-lg group overflow-hidden">
            ...
            <div className="p-5 absolute md:top-[25%] md:mt-2 -mt-10 top-[20%] opacity-0 transition-all duration-300
                ...
                <Link rel="canonical" href={props.link} target="_blank">
                    <button type="button" className="menu text-white bg-[#24292F]  focus:ring-[#24292F]/50 font-medium rounded-lg text-sm md:px-5 md:py-2.5 px-2 py-1 text-center inline-flex items-center flex-row mr-2 mb-2 transition-all duration-300">
